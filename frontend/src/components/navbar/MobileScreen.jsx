...
const MobileScreen = () => {
  ...
  return (
    <div id="navbar-default" ref={menuRef}>
      <ul
        className={`absolute -right-full z-10 font-medium flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 rtl:space-x-reverse dark:bg-gray-800 dark:border-gray-700 transition ${
          isMenuOpen ? "-right-0" : ""
        }`}
      >
        <li>
